...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=_b(
        ...
        '\n\x0e\x64iagnostics_v1\x12\x35\n\x0b\x64iagnostics\x18\x01 \x03('
        '\x0b\x32 .diagnostics_v1.DiagnosticsEntry\x1a\x32\n\x10'
        '\x44iagnosticsEntry\x12\x0b\n\x03key\x18\x01 \x01('
...
_DIAGNOSTICS_V1_DIAGNOSTICSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key', full_name='diagnostics_v1.DiagnosticsEntry.key',
            index=0,
        ...
        _descriptor.FieldDescriptor(
            name='value', full_name='diagnostics_v1.DiagnosticsEntry.value',
            index=1,
...
_DIAGNOSTICS_V1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='diagnostics',
            full_name='diagnostics_v1.diagnostics',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_DIAGNOSTICS_V1.fields_by_name[
    'diagnostics'].message_type = _DIAGNOSTICS_V1_DIAGNOSTICSENTRY
DESCRIPTOR.message_types_by_name['diagnostics_v1'] = _DIAGNOSTICS_V1
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

diagnostics_v1 = _reflection.GeneratedProtocolMessageType(
    'diagnostics_v1',
    (_message.Message,),
    dict(
        DiagnosticsEntry=_reflection.GeneratedProtocolMessageType(
            'DiagnosticsEntry',
            (
                _message.Message,
            ),
