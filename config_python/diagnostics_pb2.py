...
diagnostics_v1 = _reflection.GeneratedProtocolMessageType('diagnostics_v1', (_message.Message,), dict(

  DiagnosticsEntry = _reflection.GeneratedProtocolMessageType('DiagnosticsEntry', (_message.Message,), dict(
