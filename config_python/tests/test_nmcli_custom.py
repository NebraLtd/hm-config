...
from config_python.nmcli_custom import CustomSystemCommand
from config_python.nmcli_custom import _syscmd
from config_python.nmcli_custom import disable_use_sudo
